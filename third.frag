...
void main() {
  ...
  color *= smoothstep(0., y - tiles * 5. / 8., -sin((x / 0.2 / tiles) - u_time) * (.015 / tilewidth) * cos(u_time / 6.)) * 3. - 1.;

  color *= smoothstep(0., y - tiles * 3. / 8., -sin((x / 0.2 / tiles) - u_time) * (.015 / tilewidth) * cos(u_time / 6.)) * 3. - 1.;
